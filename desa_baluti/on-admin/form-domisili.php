...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    INSERT INTO domisili (id_penduduk, alamat_asal, alamat_tujuan, no_surat, ket)
    VALUES (?, ?, ?, ?, ?)");
    $stmt->bind_param(
        "issss",
        $id_penduduk,
    ...
    if ($stmt->execute()) {
        ...
        window.location.href = 'form-domisili.php';
    </script>";
    }
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                            ...
                                            <input class="form-control" type="text" name="alamat_asal" placeholder="Masukkan alamat asal" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                            ...
                                            <input class="form-control" type="date" name="tgl_domisili" required />
                                        </div>
                                    </div>
                                </div>
                                <div class="pt-4">
