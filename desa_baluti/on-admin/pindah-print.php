...
if (isset($_GET['dari_tanggal']) && isset($_GET['sampai_tanggal']) && !empty($_GET['dari_tanggal']) && !empty($_GET['sampai_tanggal'])) {
    ...
    // Query laporan berdasarkan tanggal pindah
    $query = "SELECT * FROM pindah n
            JOIN penduduk p ON n.id_penduduk = p.id_penduduk
            WHERE n.tgl_pindah BETWEEN ? AND ?
            ORDER BY n.tgl_pindah DESC";
...
<head>
    ...
    <title>Laporan Penduduk Pindah</title>
    <!-- Favicon -->
...
<body>
    ...
    <h2 style="text-align: center;">Laporan Penduduk Pindah</h2>
    ...
    <table class="tabel-laporan">
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<tr>";
                echo "<td colspan='17' style='text-align: center;'>Tidak ada data ditemukan</td>";
                echo "</tr>";
            }
            ?>
        </tbody>
