...
if (!empty($_GET['dari_tanggal']) && !empty($_GET['sampai_tanggal'])) {
    ...
    $query .= " AND h.tgl_usaha BETWEEN '$dari_tanggal' AND '$sampai_tanggal'";
}

// Urutkan berdasarkan tanggal pengajuan terbaru
$query .= " ORDER BY h.tgl_usaha DESC";
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                            ...
                            <form method="GET" action="">
                                <div class="row align-items-end">
                                    ...
                                    <?php if (!empty($_GET['dari_tanggal']) && !empty($_GET['sampai_tanggal'])): ?>
                                        <div class="col-md-3">
                                            <label>&nbsp;</label>
                                            <a href="usaha-print.php?dari_tanggal=<?= $_GET['dari_tanggal'] ?>&sampai_tanggal=<?= $_GET['sampai_tanggal'] ?>"
                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <button class="btn btn-secondary" onclick="window.location.href='form-usaha.php'"><i class="mdi mdi-pen-plus me-1"></i>Buat Surat ket Usaha</button>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td>" . (!empty($row['tgl_usaha']) ? date("d-m-Y", strtotime($row['tgl_usaha'])) : '') . "</td>";
                                                echo "<td>" . (isset($row['ket']) ? htmlspecialchars($row['ket']) : '-') . "</td>";
                                                echo "<td>
                                                    <a href='edit-usaha.php?id_usaha=" . $row['id_usaha'] . "' class='btn btn-primary mr-1'><i class='fa fa-pencil'></i></a>
                                                    <a href='hapus-usaha.php?id_usaha=" . $row['id_usaha'] . "' class='btn btn-danger mr-1 ' onclick='return confirm(\"Apakah Anda yakin ingin menghapus data ini?\")'><i class='fa fa-trash'></i></a>
                                                    <a href='print-usaha.php?id_usaha=" . $row['id_usaha'] . "' class='btn btn-success mr-1' target='_blank' onclick='openPrint(this.href)'><i class='fa fa-print'></i></a>
                                                </td>";
                                                echo "</tr>";
                                            }
                                        } else {
