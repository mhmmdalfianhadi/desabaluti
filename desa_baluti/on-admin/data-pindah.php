...
if (!empty($_GET['dari_tanggal']) && !empty($_GET['sampai_tanggal'])) {
    ...
    $query .= " AND n.tgl_pindah BETWEEN '$dari_tanggal' AND '$sampai_tanggal'";
}

// Urutkan berdasarkan tanggal pengajuan terbaru
$query .= " ORDER BY n.tgl_pindah DESC";
                            ...
                            <form method="GET" action="">
                                <div class="row align-items-end">
                                    ...
                                    <?php if (!empty($_GET['dari_tanggal']) && !empty($_GET['sampai_tanggal'])): ?>
                                        <div class="col-md-3">
                                            <label>&nbsp;</label>
                                            <a href="pindah-print.php?dari_tanggal=<?= $_GET['dari_tanggal'] ?>&sampai_tanggal=<?= $_GET['sampai_tanggal'] ?>"
                                    ...
                                    <tbody>
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td>" . (!empty($row['tgl_pindah']) ? date("d-m-Y", strtotime($row['tgl_pindah'])) : '') . "</td>";
