...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $koneksi->prepare("INSERT INTO pindah (id_penduduk, alamat_tujuan, desa_tujuan, kecamatan_tujuan, kabupaten_tujuan, no_surat, tgl_pindah, ket) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param(
        "isssssss",  // Tipe data: i = integer, s = string
        $id_penduduk,
        $alamat_tujuan,
        $desa_tujuan,
        $kecamatan_tujuan,
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                            ...
                                            <input class="form-control" type="date" name="tgl_pindah" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-2">
