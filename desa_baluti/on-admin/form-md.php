...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $koneksi->prepare("INSERT INTO md (id_penduduk, hari, tanggal, waktu, tempat, disebabkan, no_surat, ket)  VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param(
        "isssssss",
        $id_penduduk,
        $hari,
    ...
    if ($stmt->execute()) {
        ...
        window.location.href = 'form-md.php';
    </script>";
    }
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card mb-4">
                            <h5 class="card-header">Formulir Surat Keterangan Meninggal Dunia</h5>
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                            ...
                                            <input class="form-control" type="text" name="hari" placeholder="Masukkan hari kejadian" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                            ...
                                            <input class="form-control" type="text" name="tempat" placeholder="Masukkan tempat kejadian" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                            <label for="disebabkan" class="form-label">Disebabkan Oleh</label>
                                            <input class="form-control" type="text" name="disebabkan" placeholder="Masukkan penyebab kejadian" required />
                                        </div>
                                    </div>
                                </div>
                                <div class="pt-4">
