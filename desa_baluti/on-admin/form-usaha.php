...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $koneksi->prepare("INSERT INTO usaha (id_penduduk, alamat_usaha, jenis_usaha, penghasilan, no_surat, tgl_usaha, ket) VALUES (?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param(
        "issssss",
        $id_penduduk,
        $alamat_usaha,
    ...
    if ($stmt->execute()) {
        ...
        window.location.href = 'form-usaha.php';
    </script>";
    }
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card mb-4">
                            <h5 class="card-header">Formulir Surat Keterangan Usaha</h5>
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                            ...
                                            <input class="form-control" type="text" name="alamat_usaha" placeholder="Masukkan alamat usaha" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                            <label for="jenis_usaha" class="form-label">Jenis Usaha</label>
                                            <input class="form-control" type="text" name="jenis_usaha" placeholder="Masukkan jenis usaha" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                            <label for="penghasilan" class="form-label">Penghasilan Perbulan</label>
                                            <input class="form-control" type="number" min="0" name="penghasilan" placeholder="Masukkan penghasilan" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                            <label for="tgl_usaha" class="form-label">Tanggal Usaha</label>
                                            <input class="form-control" type="date" name="tgl_usaha" required />
                                        </div>
                                    </div>
                                </div>
                                <div class="pt-4">
