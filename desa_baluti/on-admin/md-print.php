...
<body>
    ...
    <h2 style="text-align: center;">Laporan Penduduk Meninggal Dunia</h2>
    ...
    <table class="tabel-laporan">
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<tr>";
                echo "<td colspan='18' style='text-align: center;'>Tidak ada data ditemukan</td>";
                echo "</tr>";
            }
            ?>
        </tbody>
