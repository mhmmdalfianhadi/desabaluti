...
$id_usaha = isset($_GET['id_usaha']) ? intval($_GET['id_usaha']) : 0;
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $tgl_usaha = !empty($_POST['tgl_usaha']) ? date('Y-m-d', strtotime($_POST['tgl_usaha'])) : NULL;
    $ket = $_POST['ket'];

    // Update data ke dalam database berdasarkan id_usaha
    $stmt = $koneksi->prepare("UPDATE usaha SET id_penduduk = ?, alamat_usaha = ?, jenis_usaha = ?, penghasilan = ?, no_surat = ?, tgl_usaha = ?, ket = ? WHERE id_usaha = ?");
    $stmt->bind_param(
        "issssssi",
        $id_penduduk,
        $alamat_usaha,
    ...
    $stmt = $koneksi->prepare("SELECT * FROM usaha WHERE id_usaha = ?");
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card mb-4">
                            <h5 class="card-header">Formulir Edit Surat Keterangan Usaha</h5>
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                            ...
                                            <input class="form-control" type="text" name="alamat_usaha" value="<?php echo htmlspecialchars($alamat_usaha); ?>" placeholder="Masukkan alamat usaha" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                            <label for="jenis_usaha" class="form-label">Jenis Usaha</label>
                                            <input class="form-control" type="text" name="jenis_usaha" value="<?php echo htmlspecialchars($jenis_usaha); ?>" placeholder="Masukkan jenis usaha" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                            <label for="penghasilan" class="form-label">Penghasilan</label>
                                            <input class="form-control" type="number" min="0" name="penghasilan" value="<?php echo htmlspecialchars($penghasilan); ?>" placeholder="Masukkan penghasilan" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                            <label for="tgl_usaha" class="form-label">Tanggal Usaha</label>
                                            <input class="form-control" type="date" name="tgl_usaha"
                                                value="<?= htmlspecialchars($tgl_usaha) ?>" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                    ...
                                    <div class="pt-4">
                                        ...
                                        <button type="button" class="btn btn-danger me-sm-3 me-1" onclick="window.location.href='data-usaha.php';">Batal</button>
                                    </div>
                                </div>
                            </form>
                        </div>
