...
if (isset($_GET['dari_tanggal']) && isset($_GET['sampai_tanggal']) && !empty($_GET['dari_tanggal']) && !empty($_GET['sampai_tanggal'])) {
    $dari_tanggal = $_GET['dari_tanggal'];
    $sampai_tanggal = $_GET['sampai_tanggal'];

    // Query laporan berdasarkan tanggal domisili
    $query = "SELECT * FROM domisili d
            JOIN penduduk p ON d.id_penduduk = p.id_penduduk
            WHERE d.tgl_domisili BETWEEN ? AND ?
            ORDER BY d.tgl_domisili DESC";
...
<head>
    ...
    <title>Laporan Domisili Penduduk</title>
    <!-- Favicon -->
...
<body>
    ...
    <h2 style="text-align: center;">Laporan Domisili Penduduk</h2>
    ...
    <table class="tabel-laporan">
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<tr>";
                echo "<td colspan='14' style='text-align: center;'>Tidak ada data ditemukan</td>";
                echo "</tr>";
            }
            ?>
        </tbody>
