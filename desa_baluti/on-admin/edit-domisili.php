...
$id_domisili = isset($_GET['id_domisili']) ? intval($_GET['id_domisili']) : 0;
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $tgl_domisili = !empty($_POST['tgl_domisili']) ? date('Y-m-d', strtotime($_POST['tgl_domisili'])) : NULL;
    $ket = $_POST['ket'];

    // Update data ke dalam database berdasarkan id_sktm
    $stmt = $koneksi->prepare("UPDATE domisili SET id_penduduk = ?, alamat_asal = ?, alamat_tujuan = ?, no_surat = ?, tgl_domisili = ?, ket = ? WHERE id_domisili = ?");
    $stmt->bind_param("isssssi", $id_penduduk, $alamat_asal, $alamat_tujuan, $no_surat, $tgl_domisili, $ket, $id_domisili);
    ...
    $stmt = $koneksi->prepare("SELECT * FROM domisili WHERE id_domisili = ?");
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card mb-4">
                            <h5 class="card-header">Formulir Surat Keterangan Domisili</h5>
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                            ...
                                            <input class="form-control" type="text" name="alamat_asal" value="<?php echo htmlspecialchars($alamat_asal); ?>" placeholder="Masukkan alamat asal" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                            <label for="tgl_domisili" class="form-label">Tanggal Domisili</label>
                                            <input class="form-control" type="date" name="tgl_domisili"
                                                value="<?= htmlspecialchars($tgl_domisili) ?>" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                    ...
                                    <div class="pt-4">
                                        ...
                                        <button type="button" class="btn btn-danger me-sm-3 me-1" onclick="window.location.href='data-domisili.php';">Batal</button>
                                    </div>
                                </div>
                            </form>
                        </div>
