                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <button class="btn btn-secondary" onclick="window.location.href='form-penduduk.php'"><i class="mdi mdi-pen-plus me-1"></i>Tambah Penduduk</button>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td>
                                                    <a href='edit-penduduk.php?id_penduduk=" . $row['id_penduduk'] . "' class='btn btn-primary mr-1'><i class='fa fa-pencil'></i></a>
                                                    <a href='hapus-penduduk.php?id_penduduk=" . $row['id_penduduk'] . "' class='btn btn-danger mr-1' onclick='return confirm(\"Apakah Anda yakin ingin menghapus data ini?\")'><i class='fa fa-trash'></i></a>
                                                </td>";
                                                echo "</tr>";
                                            }
                                        } else {
                                            echo "<tr>";
                                            echo "<td colspan='9' style='text-align: center;'>Tidak ada data ditemukan</td>";
                                            echo "</tr>";
                                        }
                                        ?>
                                    </tbody>
