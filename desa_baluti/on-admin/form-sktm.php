...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Set nilai NULL untuk no_surat (karena belum ada nomor surat)
    $no_surat = NULL;
    $ket = NULL;

    // Masukkan data ke dalam database
    $stmt = $koneksi->prepare("
        INSERT INTO sktm (id_penduduk, keperluan, no_surat, tgl_sktm, ket)
        VALUES (?, ?, ?, ?, ?)
    ");
    $stmt->bind_param(
        "issss",
    ...
    if ($stmt->execute()) {
        ...
        window.location.href = 'form-sktm.php';
    </script>";
    }
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                            ...
                                            <input class="form-control" type="date" name="tgl_sktm" required />
                                        </div>
                                    </div>
                                </div>
                                <div class="pt-4">
