...
$id_md = isset($_GET['id_md']) ? intval($_GET['id_md']) : 0;
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $waktu = $_POST['waktu'];
    $tempat = $_POST['tempat'];
    $disebabkan = $_POST['disebabkan'];
    $no_surat = $_POST['no_surat'];
    $ket = $_POST['ket'];

    // Update data ke dalam database berdasarkan id_md
    $stmt = $koneksi->prepare("UPDATE md SET id_penduduk = ?, hari = ?, tanggal = ?, waktu = ?, tempat = ?, disebabkan = ?, no_surat = ?, ket = ? WHERE id_md = ?");
    $stmt->bind_param(
        "isssssssi",
        $id_penduduk,
        $hari,
    ...
    if ($stmt->execute()) {
        echo "<script>
            ...
            window.location.href = 'data-md.php';
        </script>";
    } else {
        echo "<script>
    ...
    $stmt = $koneksi->prepare("SELECT * FROM md WHERE id_md = ?");
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                            ...
                                            <input class="form-control" type="text" name="hari" value="<?php echo htmlspecialchars($hari); ?>" placeholder="Masukkan hari kejadian" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                            ...
                                            <input class="form-control" type="date" name="tanggal" value="<?php echo htmlspecialchars($tanggal); ?>" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                            ...
                                            <input class="form-control" type="time" name="waktu" value="<?php echo htmlspecialchars($waktu); ?>" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                            ...
                                            <input class="form-control" type="text" name="tempat" value="<?php echo htmlspecialchars($tempat); ?>" placeholder="Masukkan tempat kejadian" required />
                                        </div>
                                    </div>

                                    <div class="col-md-6">
                                        <div class="mb-2">
                                            <label for="disebabkan" class="form-label">Disebabkan Oleh</label>
                                            <input class="form-control" type="text" name="disebabkan" value="<?php echo htmlspecialchars($disebabkan); ?>" placeholder="Masukkan penyebab kejadian" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                    ...
                                    <div class="pt-4">
                                        ...
                                        <button type="button" class="btn btn-danger me-sm-3 me-1" onclick="window.location.href='data-md.php';">Batal</button>
                                    </div>
                                </div>
                            </form>
                        </div>
