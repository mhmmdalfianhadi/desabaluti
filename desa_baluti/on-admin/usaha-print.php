...
if (isset($_GET['dari_tanggal']) && isset($_GET['sampai_tanggal']) && !empty($_GET['dari_tanggal']) && !empty($_GET['sampai_tanggal'])) {
    ...
    // Query laporan berdasarkan tanggal usaha
    $query = "SELECT * FROM usaha h
            JOIN penduduk p ON h.id_penduduk = p.id_penduduk
            WHERE h.tgl_usaha BETWEEN ? AND ?
            ORDER BY h.tgl_usaha DESC";
...
<head>
    ...
    <title>Laporan Keterangan Usaha</title>
    <!-- Favicon -->
...
<body>
    ...
    <h2 style="text-align: center;">Laporan Keterangan Usaha</h2>
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>" . htmlspecialchars($row['penghasilan']) . "</td>";
                    echo "<td>" . ($row['ket']) . "</td>";
                    echo "</tr>";
                }
            } else {
                echo "<tr>";
                echo "<td colspan='15' style='text-align: center;'>Tidak ada data ditemukan</td>";
                echo "</tr>";
            }
            ?>
        </tbody>
