...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    INSERT INTO kepala (nama, alamat, no_hp, tahun_menjabat)
    VALUES (?, ?, ?, ?)");
    $stmt->bind_param(
        "ssss",
        $nama,
    ...
    if ($stmt->execute()) {
        ...
        window.location.href = 'form-kepala.php';
    </script>";
    }
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card mb-4">
                            <h5 class="card-header">Formulir Kepala Desa</h5>
                            <form class="card-body" method="post">
                                <div class="row g-4">
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                            <label for="nama" class="form-label">Nama</label>
                                            <input class="form-control" type="text" name="nama" placeholder="Masukkan nama kepala desa" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                            ...
                                            <input class="form-control" type="text" name="alamat" placeholder="Masukkan alamat kepala desa" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                            ...
                                            <input class="form-control" type="text" name="no_hp" placeholder="Masukkan nomor HP kepala desa" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                            <label for="tahun_menjabat" class="form-label">Tahun Menjabat</label>
                                            <input class="form-control" type="text" name="tahun_menjabat" placeholder="Masukkan tahun menjabat kepala desa" required />
                                        </div>
                                    </div>
                                </div>
                                <div class="pt-4">
