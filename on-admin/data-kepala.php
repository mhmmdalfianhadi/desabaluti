...
<head>
    ...
    <title>Desa Baluti - Kepala Desa</title>
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h5 class="mb-0">Data Kepala Desa</h5>
                                <button class="btn btn-secondary" onclick="window.location.href='form-kepala.php'"><i class="mdi mdi-pen-plus me-1"></i>Tambah Kepala Desa</button>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td>
                                                    <a href='edit-kepala.php?id_kepala=" . $row['id_kepala'] . "' class='btn btn-primary mr-1'><i class='fa fa-pencil'></i></a>
                                                    <a href='hapus-kepala.php?id_kepala=" . $row['id_kepala'] . "' class='btn btn-danger mr-1' onclick='return confirm(\"Apakah Anda yakin ingin menghapus data ini?\")'><i class='fa fa-trash'></i></a>
                                                </td>";
                                                echo "</tr>";
                                            }
                                        } else {
