...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $koneksi->prepare("UPDATE domisili SET id_penduduk = ?, alamat_asal = ?, alamat_tujuan = ?, no_surat = ?, ket = ? WHERE id_domisili = ?");
    $stmt->bind_param("issssi", $id_penduduk, $alamat_asal, $alamat_tujuan, $no_surat, $ket, $id_domisili);
