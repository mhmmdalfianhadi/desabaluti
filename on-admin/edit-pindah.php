...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $koneksi->prepare("UPDATE pindah SET id_penduduk = ?, alamat_tujuan = ?, desa_tujuan = ?, kecamatan_tujuan = ?, kabupaten_tujuan = ?, no_surat = ?, ket = ? WHERE id_pindah = ?");
    $stmt->bind_param("issssssi", $id_penduduk, $alamat_tujuan, $desa_tujuan, $kecamatan_tujuan, $kabupaten_tujuan, $no_surat, $ket, $id_pindah);
